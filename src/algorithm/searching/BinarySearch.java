...
//        }
        ...
        if (binarySearchRecursive(0, arr.length, arr, key) == 1) {
            return true;
        } else if (binarySearchRecursive(0, arr.length, arr, key) == 0) {
            return false;
        }
    ...
    public static int binarySearchRecursive(int l, int h, int [] arr, int key) {
        if (l == h) {
            if (arr[l] == key) {
                return 1;
            } else {
            ...
            if (arr[mid] ==key) {
                ...
                return binarySearchRecursive(l, mid-1, arr, key);
            } else {
                return binarySearchRecursive(mid + 1, h, arr, key);
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Key Found : "+binarySearch(arr, 50));
    }
}
